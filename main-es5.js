...
module.exports = "<div class=\"narrow\">  \r\n    <p><a class=\"language\" [routerLink]=\"\" (click)=\"changeLanguage('pt')\">Português</a> | <a class=\"language\" [routerLink]=\"\" (click)=\"changeLanguage('en')\">English</a></p>\r\n    <h1 translate>INTRO_PHOTO_CONTEST</h1>\r\n    <p translate>INTRO_WELCOME</p>\r\n    <p translate>INTRO_PICK</p>\r\n    <p class=\"option-description\" translate>INTRO_MERGESORT_DESCRIPTION</p>\r\n    <p class=\"button\"><button (click)=\"chooseAlgorithm('mergesort')\" translate [translateParams]=\"{mergeSortQuantity: mergeSortQuantity}\">INTRO_MERGESORT_BUTTON</button></p>\r\n    <p class=\"option-description\" translate>INTRO_ELIMINATION_DESCRIPTION</p>\r\n    <p class=\"button\"><button (click)=\"chooseAlgorithm('elimination')\" translate [translateParams]=\"{eliminationQuantity: eliminationQuantity}\">INTRO_ELIMINATION_BUTTON</button></p>\r\n    <hr>\r\n    <h2 translate>INTRO_ADDITIONAL_DETAILS</h2>\r\n    <h3 translate>INTRO_MERGESORT_TITLE</h3>\r\n    <p><span translate>INTRO_MERGESORT_DETAILS_1</span> (<a href=\"https://en.wikipedia.org/wiki/Merge_sort\" translate>INTRO_MERGESORT_DETAILS_2</a>) <span translate>INTRO_MERGESORT_DETAILS_3</span></p>\r\n    <h3 translate>INTRO_ELIMINATION_TITLE</h3>\r\n    <p [innerHTML]=\"'INTRO_ELIMINATION_DETAILS' | translate\">\r\n    <h3 translate>INTRO_VOTES_COMPUTED_TITLE</h3>\r\n    <p translate>INTRO_VOTES_COMPUTED_DETAILS</p>\r\n    <h3 translate>INTRO_WHY_2_TYPES_TITLE</h3>\r\n    <p translate>INTRO_WHY_2_TYPES_DETAILS</p>\r\n    <h3 translate>INTRO_RULES_TITLE</h3>\r\n    <p translate>INTRO_RULES_DETAILS</p>\r\n    <h3 translate>INTRO_CONTESTANTS_TITLE</h3>\r\n    <p translate>INTRO_CONTESTANTS_DETAILS</p>\r\n    <h3 translate>INTRO_SOURCE_CODE_TITLE</h3>\r\n    <p><a href=\"https://github.com/matheuscamargo/photo-contest\">https://github.com/matheuscamargo/photo-contest</a></p>\r\n</div>\r\n"
...
var EliminationAlgorithmService = /** @class */ (function () {
    ...
    EliminationAlgorithmService.prototype.normalizeScores = function (results) {
        var reducedResults = results.map(function (r) { return { elementIndex: r.elementIndex, score: Math.floor(r.score / 2) }; });
        var totalScore = reducedResults.map(function (r) { return r.score; }).reduce(function (prev, next) { return prev + next; });
        var adjustFactor = this.totalDesiredScore / totalScore;
        return reducedResults.map(function (r) {
...
var MergesortAlgorithmService = /** @class */ (function () {
    ...
    MergesortAlgorithmService.prototype.normalizeScores = function (results) {
        var totalScore = this.results.map(function (r) { return r.score; }).reduce(function (prev, next) { return prev + next; });
        var adjustFactor = this.totalDesiredScore / totalScore;
        this.results = this.results.map(function (r) {
            return { elementIndex: r.elementIndex, score: Math.round(r.score * adjustFactor) };
        });
    };
...
module.exports = "body {\n  color: #444;\n  font-family: \"Trebuchet MS\", Verdana, Helvetica, Arial, sans-serif;\n  font-size: 1.1em;\n  line-height: 1.4;\n}\n\nbutton, a.button {\n  font-family: \"Trebuchet MS\";\n  background-color: #303f9f;\n  border: 0.1rem solid #303f9f;\n  margin: 0 auto;\n  left: 50%;\n  border-radius: 0.4rem;\n  color: #fff;\n  cursor: pointer;\n  font-size: 1.1rem;\n  font-weight: 700;\n  letter-spacing: 0.1rem;\n  line-height: 3.8rem;\n  padding: 0 3rem;\n  text-align: center;\n  text-transform: uppercase;\n  text-decoration: none;\n}\n\nbutton:hover, button:focus, a.button:hover, a.button:focus {\n  background-color: #444;\n  border-color: #444;\n  color: #fff;\n}\n\nli {\n  margin-bottom: 1.5rem;\n}\n\nul {\n  list-style: none;\n}\n\nh1, h2 {\n  text-align: center;\n  font-weight: 300;\n  letter-spacing: -0.1rem;\n  margin-bottom: 1.5rem;\n  margin-top: 0;\n}\n\nh1 {\n  font-size: 3rem;\n  line-height: 1.2;\n}\n\nh2 {\n  font-size: 2rem;\n  line-height: 1.25;\n}\n\ndiv.narrow {\n  max-width: 900px;\n  margin: auto;\n}\n\na {\n  color: #303f9f;\n  text-decoration: none;\n}\n\na:hover {\n  text-decoration: underline;\n}\n\np.button {\n  text-align: center;\n  margin-top: 0;\n  margin-bottom: 30px;\n}\n\np.option-description {\n  font-weight: 900;\n  text-align: center;\n  margin-bottom: 10px;\n}\n\na.language {\n  font-size: 0.8em;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
